...
- **候选人提供截图**：候选人将表单页面截图发过来，Read 工具从截图中提取表单问题和选项。
- **或粘贴文本**：直接将表单问题复制粘贴发送给助手，零损耗。

> 本项目**不使用 Playwright**。所有数据输入均通过截图/粘贴完成，由候选人主动提供，确保数据质量和安全。
...
提示候选人通过以下任一方式提供表单：
- **发送截图**：将当前表单页面的屏幕截图发过来（Read 工具能识别并分析图片）。
- **粘贴文本**：手动复制表单上的问题贴在对话框中。
- **只提供公司+职位**：直接说出公司名称与职位名称，助手从本地历史评估报告中搜索。
...
3. 推荐下一步行动：引导候选人准备 LinkedIn 或招聘平台上的招聘负责人直接沟通话术。
